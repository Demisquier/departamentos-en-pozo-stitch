  ...
  return (
    <html className={`scroll-smooth ${fontSerif.variable} ${fontSans.variable}`} lang="es">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&icon_names=add_business,analytics,apartment,arrow_back,arrow_forward,arrow_upward,auto_awesome,badge,bolt,bookmark,business,calculate,calendar_today,chat,check,check_circle,chevron_left,chevron_right,close,construction,currency_exchange,domain,download,edit_note,event,event_available,expand_more,explore,fact_check,favorite,forum,gavel,grid_view,groups,history,home,image,info,insights,location_city,location_on,login,logout,mail,map,menu,menu_book,notifications_active,open_in_new,payments,photo_library,play_arrow,progress_activity,query_stats,quiz,radio_button_unchecked,rate_review,real_estate_agent,refresh,savings,schedule,search,search_off,send,share,smart_display,space_dashboard,storefront,support_agent,table_rows,timeline,trending_up,tune,verified,verified_user&display=swap"
          rel="stylesheet"
        />
      </head>
