...
export default async function sitemap() {
  const fixed = ["/", "/desarrollos-inmobiliarios/", "/contacto/", "/sobre-nosotros/", "/novedades/", "/simulador-cuota-cac-pozo/", "/alertas-de-lanzamientos-en-pozo/", "/invertir-desde-el-exterior/", "/corralones-y-materiales-de-construccion-en-caba/", "/videos-de-emprendimientos-en-pozo/"].map((u) => ({
    url: BASE + u,
