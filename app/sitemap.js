...
export default async function sitemap() {
  const fixed = ["/", "/desarrollos-inmobiliarios/", "/contacto/", "/sobre-nosotros/", "/novedades/", "/simulador-cuota-cac-pozo/", "/alertas-de-lanzamientos-en-pozo/", "/corralones-y-materiales-de-construccion-en-caba/"].map((u) => ({
    url: BASE + u,
